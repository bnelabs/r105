class R105 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bnelabs/r105/releases/download/v2.5.0/r105-macos-arm64.tar.gz"
      sha256 "cae3c5f31566aaa7869298a3a52b109dbb6c560c4fd9fa38be49bbee61e1e563"
    else
      url "https://github.com/bnelabs/r105/releases/download/v2.5.0/r105-macos-x86_64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/bnelabs/r105/releases/download/v2.5.0/r105-linux-aarch64.tar.gz"
      sha256 "124d44ba3a95617a9af7a4aa4d6dba41c8108551985d8710dcec0f777f680a31"
    else
      url "https://github.com/bnelabs/r105/releases/download/v2.5.0/r105-linux-x86_64.tar.gz"
